...
<h2> The Predicament Pandemic </h2>
...
plot<- peru %>%
  ...
  ggplot(aes(quaters, value, colour= Variables))+
  geom_line(size = 1.2)+ 
  scale_x_continuous(breaks = seq(2020.1, 2021.3, by= .01))+
  xlim(2020.1, 2021.4)+ 
  labs(x= "Q1-20 to Q3-21",y= "Value", 
...
The above graph shows how a decent vaccination rate in Peru has improved to drag down the number of positive coronavirus cases and casualties. However, the testing drives in the country have slowed a bit in the third quarter of 2021. 
According to a [CVID-19 tracker](https://graphics.reuters.com/world-coronavirus-tracker-and-maps/vaccination-rollout-and-access/), with the help of vaccinations, Covid-19 infections in Peru are decreasing. With more than 18M doses of Covid-19, approx 31.9% of the population has received one dose, and 25% of the countries’ population is fully vaccinated. 
