...
## Data Structure 
<p> The data sets used for the analysis are given below: </p>
...
dygraph(corona, main = "Deaths and Cases of COVID-19") %>%
...
ggplot(plot2) +
  ...
  labs(x = "", y = "Number of Deaths in 2020",
       title = "<span style = 'color:#DC143C'><b>Deaths</b></span> and <span style = 'color:#dc6d02'><b>Cases</b></span> due to COVID-19"))
...
sankey <- htmlwidgets::prependContent(p, htmltools::tags$h4("Cause of Deaths in Each Month"))
